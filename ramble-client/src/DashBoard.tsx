...
const DashBoard: FC = () => {
    ...
    return (
        <div className="grid grid-rows-[auto_60px] sm:grid-rows-1 sm:grid-cols-[180px_auto] h-screen">
            ...
            <div className="flex items-center flex-row sm:flex-col row-start-2 sm:row-start-1 text-xl border-t-2  sm:border-r-2 sm:border-t-0">
                
                {/* Extra title branding, could be substituted for an icon */}
                <div className="hidden sm:block py-2 border-b-2 w-full">
                    <div className="text-2xl text-center font-semibold">Ramble</div>
                </div>
